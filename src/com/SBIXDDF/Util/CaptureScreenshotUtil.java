...
public class CaptureScreenshotUtil implements ITestListener{
	...
	public void onTestSuccess(ITestResult tr) {
		...
		if(PageBase.config.getProperty("screenShotOnPass").equalsIgnoreCase("yes"))
		{
	...
	public void onTestFailure(ITestResult tr) {		
		...
		if(PageBase.config.getProperty("screenShotOnFail").equalsIgnoreCase("yes"))
		{
	...
	public void captureScreenShot(ITestResult result, String status){	
		...
		File scrFile = ((TakesScreenshot) PageBase.driver).getScreenshotAs(OutputType.FILE);
